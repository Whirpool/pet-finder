...
/**
 * This is the model class for table "data_dog_lost".
 *
 * The followings are the available columns in table 'data_dog_lost':
 ...
 */
class DogLost extends CActiveRecord
{
    ...
    public function behaviors()
    {
        return array(
            'petFinder'=>array(
                'class'=>'application.components.PetBehaviors.DogLostBehavior',
            ),
    ...
    public function rules()
    {
        ...
        return array(
            array('sex, date, author, location, eyes, colors, fur, type_color, figured, age, name', 'required'),
            array('status, author, eyes, fur, type_color, figured', 'numerical', 'integerOnly'=>true),
            array('name', 'length', 'max'=>64),
            array('sigma, special, advanced', 'safe'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('sigma, sex, special, advanced, date, date_create, date_update, status, author, location, eyes, colors, fur, type_color, figured, age, name, id', 'safe', 'on'=>'search'),
        );
    }
     ...
     * @return DogLost the static model class
     */
