...
/**
 * Class DogFindBehavior
 *
 * Конечный класс с реализацией методов формирования всех параметров для результатирующего запроса
 */
final class DogFindBehavior extends AbstractBasePetBehavior implements SearchByLocationInterface
{
    use DogTrait, FindTrait;
    ...
    {
        $commonPet = new Pet;
        $commonPet->type   = Pet::INT_TYPE_DOG;
